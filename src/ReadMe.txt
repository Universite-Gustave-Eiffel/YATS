========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet TestRunConsolWin32Project
========================================================================

AppWizard a créé cette application TestRunConsolWin32Project pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application TestRunConsolWin32Project.


TestRunConsolWin32Project.vcxproj
...
TestRunConsolWin32Project.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé TestRunConsolWin32Project.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
